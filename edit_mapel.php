  ...
  <div class="container col-md-6 mt-4">
    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        $id = $_GET['id_matpel']; //mengambil id barang yang ingin diubah

        //menampilkan barang berdasarkan id
        $data = mysqli_query($koneksi, "select * from tb_matpel where id_matpel = '$id'");
        ...
        <form action="" method="post" role="form">
          <div class="form-group">
            ...
            <input type="text" name="nama_matpel" required="" class="form-control" value="<?= $row['kode_buku']; ?>">
            <!-- ini digunakan untuk menampung id yang ingin diubah -->
            <input type="hidden" name="id_matpel" required="" value="<?= $row['id']; ?>">
          </div>
          <div class=" form-group">
